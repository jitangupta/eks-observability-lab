...
The implemented Fault 1 and Fault 2 workflows are documented in
[`faults/README.md`](faults/README.md). Always run the relevant non-mutating
`preflight` command and inspect the PASS manifest before an authorized live
injection.
